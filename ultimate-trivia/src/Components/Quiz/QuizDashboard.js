    ...
    return (
        <div className="quiz-container">
            <div className="quizes-container">
                ...
                <div onClick={() => handleQuizClick('Fill in the Blanks')}>Fill in the Blanks</div>
                <div onClick={() => handleQuizClick('Quiz with Compiler')}>Quiz with Compiler</div>
                <div onClick={() => handleQuizClick('Bubble Pop Quiz')}>Bubble Pop Quiz</div>
                <div onClick={() => handleQuizClick('Four Pics One Word')}>Four Pics One Word</div>
            </div>
